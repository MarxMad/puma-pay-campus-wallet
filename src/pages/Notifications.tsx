  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] pb-20 overflow-x-hidden w-full max-w-full">
      <AppHeader
        ...
        rightAction={<MoreVertical className={headerIconClass} />}
      />
          ...
          <Card className="bg-gray-800 border-gray-700 p-4">
            <div className="flex items-center justify-between">
              <span className="text-white text-sm">
                ...
                variant="ghost" 
                  size="sm"
                className="text-red-400 hover:text-red-400 hover:bg-red-500/10 rounded px-1"
                >
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex items-center space-x-2 ml-2">
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        className="text-gray-500 hover:text-gray-500 hover:bg-red-500/10 p-1 rounded"
                        onClick={(e) => {
                          e.stopPropagation();
